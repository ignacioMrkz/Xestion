		...
		<div class="col-md-6">
			<div class="box box-danger">
				...
				<div class="box-footer with-border text-center">
					Mozas {!!round(100*(moza12Edicion($edicion)+moza17Edicion($edicion)+moza26Edicion($edicion))/(moza12Edicion($edicion)+moza17Edicion($edicion)+moza26Edicion($edicion)+mozo12Edicion($edicion)+mozo17Edicion($edicion)+mozo26Edicion($edicion)), 1)!!}% | Mozos {!!round(100*(mozo12Edicion($edicion)+mozo17Edicion($edicion)+mozo26Edicion($edicion))/(moza12Edicion($edicion)+moza17Edicion($edicion)+moza26Edicion($edicion)+mozo12Edicion($edicion)+mozo17Edicion($edicion)+mozo26Edicion($edicion)), 1)!!}%
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	var idadeChart = new Chart(ctx3, {
		...
		data: {
			datasets: [{
				data: [{!!moza12Edicion($edicion)!!}, {!!moza17Edicion($edicion)!!}, {!!moza26Edicion($edicion)!!}, {!!mozo12Edicion($edicion)!!}, {!!mozo17Edicion($edicion)!!}, {!!mozo26Edicion($edicion)!!}],
				backgroundColor: ['#80cbc4', '#4db6ac', '#26a69a', '#fff59d', '#ffee58', '#fdd835'],
			}],
			labels: ['Mozas 12-16', 'Mozas 17-25', 'Mozas 26 e +', 'Mozos 12-16', 'Mozos 17-25', 'Mozos 26 e +'],
		}
	});
